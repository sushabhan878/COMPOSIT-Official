  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      icon: "linkedin",
      url: "https://www.linkedin.com/company/composit-iit-kharagpur/",
    },
    {
      name: "Instagram",
      icon: "instagram",
      url: "https://www.instagram.com/composit_iitkgp/",
    },
    {
      name: "Facebook",
      icon: "facebook",
      url: "https://www.facebook.com/composit.iitkgp",
    },
  ];
      ...
      <div className="mx-auto max-w-10xl px-[5vw]">
        <div className="backdrop-blur-3xl bg-white/5 border border-white/15 rounded-3xl shadow-[0_20px_60px_rgba(92,10,10,0.35)] px-8 py-12 transition-all duration-300">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
            {/* Logo Section */}
            <div className="md:col-span-1 flex flex-row md:flex-col items-center md:items-start gap-3 md:gap-0">
              <Link
                href="/home"
                className="transition-opacity hover:opacity-80 mb-0 md:mb-4"
              >
                <Image
              ...
              <p className="text-xs text-white/60 max-w-[150px] md:max-w-none">
