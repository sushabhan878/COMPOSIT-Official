            ...
            <div className="mt-3 flex gap-3 sm:hidden">
              {linkedin && (
                <Link
                  ...
                  className="flex h-10 w-10 items-center justify-center rounded-full bg-white/15 text-white backdrop-blur transition-all duration-300 hover:bg-amber-400 hover:text-black hover:shadow-lg hover:shadow-amber-400/50"
                  title="LinkedIn"
                >
                  <svg
                    className="h-5 w-5"
        ...
        <div className="absolute inset-0 flex flex-col justify-between rounded-3xl bg-gradient-to-br from-white/10 via-white/5 to-white/0 p-6 shadow-2xl backdrop-blur-md [backface-visibility:hidden] [transform:rotateY(180deg)] transition-all duration-300 group-hover:ring-2 group-hover:ring-amber-400 group-hover:shadow-lg group-hover:shadow-amber-400/40">
          <div className="space-y-3">
            ...
            <p className="text-sm leading-relaxed text-gray-300">
              {description ||
                "Passionate about materials science, collaboration, and building solutions that move the world forward."}
            </p>
          </div>
