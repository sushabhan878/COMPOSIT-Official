...
async function page() {
  return (
    <main className="relative w-full h-screen overflow-hidden">
      ...
      <div className="md:absolute md:bottom-5 md:right-5 fixed inset-0 flex items-center justify-center md:inset-auto z-10 pointer-events-none md:pointer-events-auto"></div>
      <Link
        href="/home"
