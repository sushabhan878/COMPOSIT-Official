...
const headsData = [
  {
    ...
    imageUrl:
      "https://res.cloudinary.com/dohx1bvom/image/upload/v1766670891/WhatsApp_Image_2025-12-25_at_12.15.22_prmis2.jpg",
    ...
    description:
      "Overseeing overall operations and strategic direction of COMPOSIT 2026. Committed to delivering excellence.",
  },
  {
    ...
    description:
      "Steering the vision and mission of COMPOSIT. Dedicated to fostering innovation and collaboration.",
  },
  {
    name: "Sushabhan Majumdar",
    position: "Head - Web & Sponsorship",
    imageUrl:
      "https://res.cloudinary.com/dohx1bvom/image/upload/v1766856999/Suite_Profile_Pic_uwedgk.png",
    ...
    description:
      "Building robust digital presence and securing strategic partnerships for COMPOSIT.",
  },
  {
    name: "Jitam Barman",
    position: "Head - Sponsorship",
    imageUrl:
      "https://res.cloudinary.com/dohx1bvom/image/upload/v1766857694/1759955207051_tgyvzt.jpg",
    ...
    description:
      "Forging industry partnerships and securing financial support for the festival's success.",
  },
  {
    name: "Vijendra Singh Shyam",
    position: "Head - Design & Media",
    imageUrl:
      "https://res.cloudinary.com/dohx1bvom/image/upload/v1766857694/1745933651994_wvx09x.jpg ",
    ...
    description:
      "Crafting compelling visual narratives and managing brand communication across all platforms.",
  },
  {
    ...
    description:
      "Orchestrating dynamic events and creating unforgettable experiences for all participants.",
  },
  {
    name: "Jayesh Andhale",
    position: "Head - Events & PR",
    imageUrl:
      "https://res.cloudinary.com/dohx1bvom/image/upload/v1766670890/WhatsApp_Image_2025-12-25_at_12.02.38_rzi98q.jpg",
    ...
    description:
      "Coordinating event logistics and building public relations strategy to amplify COMPOSIT's impact.",
  },
  {
    name: "Ayush Ogale",
    position: "Head - Events & PR",
    imageUrl:
      "https://res.cloudinary.com/dohx1bvom/image/upload/v1766670889/1750253720690_e1g09k.jpg",
    ...
    description:
      "Driving event innovation and crafting compelling public narratives for COMPOSIT.",
  },
];
        ...
        <section className="space-y-12 mt-16">
          ...
          >
            {[
              {
                imageUrl:
                  "https://res.cloudinary.com/dohx1bvom/image/upload/v1766858327/AmlanDutta.cebd0cf0bae6d57b1429_xpifq3.jpg",
                name: "Prof. Amlan Datta",
                position: "Faculty Advisor",
                linkedin: "https://www.linkedin.com/in/amlan-dutta-a108a8148/",
                email: "amlan.dutta@metal.iitkgp.ac.in",
                description:
                  "Guiding COMPOSIT's strategic vision and academic excellence. Instrumental in shaping the festival's core values and ensuring world-class standards.",
              },
              {
                imageUrl:
                  "https://res.cloudinary.com/dohx1bvom/image/upload/v1766858328/Sankha_profile.688a415f27fd5df569fb_zpcx3m.jpg",
                name: "Prof. Sankha Mukherjee",
                position: "Faculty Advisor",
                linkedin: "https://www.linkedin.com/in/sankha-m-913867161/",
                email: "sankha@metal.iitkgp.ac.in",
                description:
                  "Mentoring the entire team and fostering innovation at every level. Committed to building a sustainable legacy through COMPOSIT.",
              },
            ].map((advisor) => (
              <motion.div
                key={advisor.name}
