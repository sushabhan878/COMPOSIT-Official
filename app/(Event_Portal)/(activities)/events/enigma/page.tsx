...
const tabSliderClass: Record<string, string> = {
  ...
  rules: "translate-x-[200%]",
  faqs: "translate-x-[300%]",
  contacts: "translate-x-[400%]",
};
        ...
        <div className="grid gap-8 lg:grid-cols-[340px,1fr] md:grid-cols-1">
          <aside className="flex flex-col gap-6 border-b border-white/15 p-8 md:border-b-0 md:border-r">
            ...
            <div className="flex w-full flex-col gap-3 md:flex-row">
              <RegistrationClosed message="Enigma registrations are now closed. Event details and rules are still available below." />
              <button
                type="button"
                onClick={() => {
