...
const events = [
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766907889/GettyImages-755651077-5b3fedf646e0fb005bc0269e_uty8jy.jpg',
    title: 'Metacode',
    description: 'Solve engaging coding challenges that blend innovation, problem-solving, and computation.',
    href: 'events/metacode',
  },
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766912201/michelearoundtheworld-ASxUnYgNnKs-unsplash_qxh9uc.jpg',
    title: 'Technova',
  ...
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766912188/istockphoto-1408304009-1024x1024_aeybis.jpg',
    title: 'Enigma',
  ...
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766912196/stephen-dawson-qwtCeJ5cLYs-unsplash_yshlx8.jpg',
    title: 'Excavate',
  ...
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766912210/bailey-mahon-2b6K4uy0Hbc-unsplash_bh9sny.jpg',
    title: 'Metaclix',
  ...
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766912214/marvin-meyer-SYTO3xs06fU-unsplash_ehgamu.jpg',
    title: 'Case Study',
  ...
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766912220/austin-distel-wD1LRb9OeEo-unsplash_tilrco.jpg',
    title: 'Ideathon',
  ...
  {
    imageUrl: 'https://res.cloudinary.com/dohx1bvom/image/upload/v1766912197/tom-claes-DkAEPVsK2_8-unsplash_pji8mu.jpg',
    title: 'Cadvolution',
  ...
  return (
    <main className="mt-20 min-h-screen py-16 lg:py-24">
      <div className="mx-auto max-w-10xl px-[5vw]">
        ...
        >
          <p className="text-sm uppercase tracking-[0.35em] text-amber-300/80">COMPOSIT 2026</p>
          <h1 className="text-3xl font-bold leading-tight text-white md:text-4xl lg:text-5xl">Events</h1>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-14 md:gap-y-16 sm:grid-cols-2 xl:grid-cols-3 place-items-center">
          {events.map((ev) => (
            <EventCard key={ev.title} imageUrl={ev.imageUrl} title={ev.title} description={ev.description} href={ev.href} />
          ))}
        </div>
      </div>
    </main>
