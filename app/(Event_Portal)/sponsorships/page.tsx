      ...
      <div className="mx-auto max-w-7xl px-[5vw]">
        ...
        <div className="mb-14 grid items-center gap-8 lg:grid-cols-2">
          <div className="space-y-4">
            <p className="text-sm uppercase tracking-[0.35em] text-amber-300/80">Sponsorship 2026</p>
            <h1 className="text-3xl font-bold leading-tight text-white md:text-4xl lg:text-5xl">
              Partner with COMPOSIT
            </h1>
            <p className="text-base text-gray-300 md:text-lg">
              Join us to power India’s premier materials science fest. Amplify your brand across campus and digital arenas with
              high-impact placements, media integrations, and exclusive visibility.
            </p>
          ...
          >
            ...
            <div className="relative space-y-3 text-white">
              <p className="text-sm font-semibold text-amber-300">Branding Avenues</p>
              <h3 className="text-2xl font-bold">Visibility that travels from arena to aftermovie</h3>
              <p className="text-sm text-gray-200">
                Feature on gates, headings, banners, teasers, website links, social reels, and campus touchpoints. Multi-channel
                reach designed to keep your brand in the spotlight.
              </p>
            </div>
          </motion.div>
        </div>
