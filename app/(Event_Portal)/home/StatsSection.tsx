      ...
      <div className="mx-auto max-w-10xl px-[5vw]">
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-4 lg:gap-8">
          ...
          <div className="group flex flex-col items-center space-y-4 text-center rounded-3xl bg-gradient-to-br from-white/5 to-white/[0.02] p-8 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:from-white/10 hover:to-white/5 hover:shadow-2xl hover:shadow-amber-500/20">
            <div className="relative">
              ...
              <div className="relative rounded-full bg-gradient-to-br from-amber-400/20 to-orange-500/20 p-5 transition-all duration-300 group-hover:from-amber-400/30 group-hover:to-orange-500/30">
                <svg className="h-8 w-8 text-amber-400 md:h-10 md:w-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              <CountUpNumber end={15000} duration={2000} isVisible={isVisible} className="text-4xl font-bold text-amber-400 md:text-5xl lg:text-6xl" />
              <p className="mt-2 text-sm font-medium text-gray-300 md:text-base">Total Footfall</p>
            </div>
          </div>
          ...
          <div className="group flex flex-col items-center space-y-4 text-center rounded-3xl bg-gradient-to-br from-white/5 to-white/[0.02] p-8 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:from-white/10 hover:to-white/5 hover:shadow-2xl hover:shadow-amber-500/20">
            <div className="relative">
              ...
              <div className="relative rounded-full bg-gradient-to-br from-orange-400/20 to-amber-500/20 p-5 transition-all duration-300 group-hover:from-orange-400/30 group-hover:to-amber-500/30">
                <svg className="h-8 w-8 text-orange-400 md:h-10 md:w-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
                </svg>
              </div>
            </div>
            <div>
              <CountUpNumber end={8} duration={1500} isVisible={isVisible} className="text-4xl font-bold text-orange-400 md:text-5xl lg:text-6xl" />
              <p className="mt-2 text-sm font-medium text-gray-300 md:text-base">Total Events</p>
            </div>
          </div>
          ...
          <div className="group flex flex-col items-center space-y-4 text-center rounded-3xl bg-gradient-to-br from-white/5 to-white/[0.02] p-8 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:from-white/10 hover:to-white/5 hover:shadow-2xl hover:shadow-amber-500/20">
            ...
            <div>
              <CountUpNumber end={25000} duration={2500} isVisible={isVisible} className="text-4xl font-bold text-amber-400 md:text-5xl lg:text-6xl" />
              <p className="mt-2 text-sm font-medium text-gray-300 md:text-base">Social Media Reach</p>
            </div>
          </div>
          ...
          <div className="group flex flex-col items-center space-y-4 text-center rounded-3xl bg-gradient-to-br from-white/5 to-white/[0.02] p-8 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:from-white/10 hover:to-white/5 hover:shadow-2xl hover:shadow-amber-500/20">
            ...
            <div>
              <CountUpNumber end={600} duration={1800} isVisible={isVisible} className="text-4xl font-bold text-orange-400 md:text-5xl lg:text-6xl" />
              <p className="mt-2 text-sm font-medium text-gray-300 md:text-base">Total Participants</p>
            </div>
          </div>
        </div>
      </div>
