  ...
  return (
    <>
      <section className="mt-16 relative isolate min-h-screen w-full overflow-hidden">
        ...
        >
          <source
            src="https://videos.pexels.com/video-files/7131670/7131670-hd_1920_1080_25fps.mp4"
            type="video/mp4"
          />
        </video>
        ...
        <div className="relative flex min-h-screen flex-col items-start justify-center gap-6 px-[5vw] py-24 text-left text-white lg:px-[5vw]">
          ...
          >
            Ready to experience{" "}
            <span className="text-balance text-4xl font-semibold leading-tight drop-shadow md:text-5xl lg:text-6xl underline decoration-amber-400 decoration-4 underline-offset-4 transition-colors duration-300 hover:text-amber-200">
              COMPOSIT 2026?
            </span>
          </motion.h1>
          ...
          >
            A three-day celebration of materials innovation, future-forward
            research, and the brightest student talent. Dive into marquee
            competitions, flagship talks, and immersive exhibitions that keep
            COMPOSIT the heartbeat of campus energy.
          </motion.p>
          ...
          >
            <span className="rounded-full bg-white/10 px-4 py-2 backdrop-blur mr-4 transition duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-amber-400/20">
              Location: IIT Kharagpur
            </span>
            <span className="rounded-full bg-white/10 px-4 py-2 backdrop-blur transition duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-amber-400/20">
          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="flex flex-col justify-center space-y-8">
              ...
              <div className="space-y-6 text-base leading-relaxed text-gray-300 md:text-lg">
                <p>
                  Materials science has shaped the development of civilizations
                  since the dawn of mankind. From the atomic level to high
                  engineering structures or the greatest space endeavors,
                  material science is intrinsically diffused in every aspect of
                  human advancement.
                </p>
                <p>
                  With the aim of raising consciousness on materials science
                  across the nation, COMPOSIT strives to nurture and enrich
                  interest in material science and metallurgy among the students
                  of the nation and explore tremendous possibilities of future
                  applications of materials science in space technology due to
                  their multi-functionality and diverse properties.
                </p>
                <p>
                  It furnishes a chance for entrepreneurs, industrialists,
                  teaching professionals, and students to experience the wide
                  beauty and nature of materials. We seek to spread awareness
                  about material science-driven innovation in research and
                  industry in everything from aerospace to medicine.
                </p>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-10xl px-[5vw]">
          ...
          <div className="mb-16 space-y-4 text-center">
            ...
            <p className="mx-auto max-w-2xl text-base text-gray-400 md:text-lg">
              Experience a diverse range of activities designed to enrich your
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            >
              <div className="flex flex-col items-center space-y-6 text-center">
                ...
                <p className="text-sm leading-relaxed text-gray-300">
                  A multitude of events ranging from mesmerizing data analytics,
                  stunning photography, compelling case studies and engaging
                  research competitions, unleashing your full potential and
                  developing a spirit of healthy competitiveness.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="flex flex-col items-center space-y-6 text-center">
                ...
                <p className="text-sm leading-relaxed text-gray-300">
                  Deliverance of guest lectures by eminent professionals in the
                  field of Materials Science, enriching your learning experience
            ...
            >
              <div className="flex flex-col items-center space-y-6 text-center">
                ...
                <p className="text-sm leading-relaxed text-gray-300">
                  Conductance of informative workshops on captivating concepts,
                  providing you with hands-on experience and practical knowledge
                  about cutting-edge research and innovations in the field of
            ...
            <div className="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-white/5 to-white/[0.02] p-8 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:from-white/10 hover:to-white/5 hover:shadow-2xl hover:shadow-amber-500/20">
              <div className="flex flex-col items-center space-y-6 text-center">
                ...
                <p className="text-sm leading-relaxed text-gray-300">
                  A plethora of engrossing webinars, providing a platform to
                  interact with prominent persnalities including Material
                  Scientists and Professionals from all across the globe and to
                  gain valuable insights about the field of Materials Science
                  and beyond.
                </p>
              </div>
            </div>
