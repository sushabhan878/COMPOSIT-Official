...
const Profiles = () => {
  ...
  // Mock data for events and teams - in production this would come from an API
  const registeredEvents = [
    ...
    },
    {
      ...
      teamMembers: ["Charlie Davis", "Diana Prince", "Eve Martinez", "Frank Miller"]
    }
  ]

  const selectedEventData = selectedEvent 
    ? registeredEvents.find(e => e.id === selectedEvent)
    : null
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-white text-center mb-2">{userData?.name || "User"}</h2>
              <p className="text-white/60 text-center mb-6">
                {registeredEvents.length > 0 ? "Event Participant" : "Not registered for any events yet"} 
              </p>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-white font-medium truncate">{userData?.email || "N/A"}</p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="w-full">
                      ...
                      <p className="text-white font-medium mb-3">{registeredEvents.length} events</p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-white font-medium text-lg">{selectedEventData.teamName}</p>
              ...
              >
                ...
                <p className="text-white font-medium text-lg">{selectedEventData.teamMembers.length + 1} members</p>
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {selectedEventData.teamMembers.map((member, idx) => (
                    <motion.div
                      key={idx}
        ...
        >
          ...
          >
            ...
            <p className="text-3xl font-bold text-white">{(selectedEventData?.teamMembers.length || 0) + 1}</p>
          </motion.div>
        </motion.div>
      </div>
    </div>
